...
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/edge-cache-rules?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/edge-cache-rules.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/edge-cache-rules?src=org_news" target="_blank">在 OpenResty Edge 中启用 HTTP 缓存</a><span>&nbsp;'
-- line 7 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com.cn/cn/edge-new-proxy?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/edge-new-proxy.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com.cn/cn/edge-new-proxy?src=org_news" target="_blank">使用 OpenResty Edge 配置一个最简单的反向代理和负载均衡器</a><span>&nbsp;'
-- line 10 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
...
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="/en/ann-1019003001.html">\n      <picture>\n        <source srcset="../images/logo.webp" type="image/webp"/><img class="news-img" src="../images/logo.png"/>\n      </picture></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '&nbsp;</strong><a href="/en/ann-1019003001.html">OpenResty 1.19.3.1</a><span>&nbsp;'
-- line 22 "news-cn.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is now released!' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n</div>'
...
-- line 4 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/edge-cache-rules?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/edge-cache-rules.png" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-cache-rules?src=org_news" target="_blank">Enable HTTP Cache in OpenResty Edge</a><span>&nbsp;'
-- line 7 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="https://blog.openresty.com/en/edge-new-proxy?src=org_news" target="_blank"><img class="news-img" src="../images/header-images/edge-new-proxy.jpg" loading="lazy"/></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New!' }})
i = i + 1 output[i] = '</strong><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'New blog post' }})
i = i + 1 output[i] = '&nbsp;</span><a href="https://blog.openresty.com/en/edge-new-proxy?src=org_news" target="_blank">Set up a Simplest Reverse Proxy and Load Balancer with OpenResty Edge</a><span>&nbsp;'
-- line 10 "news-en.tt2"
i = i + 1 output[i] = stash_get(stash, {'c', 0, 'l', { 'is published.' }})
i = i + 1 output[i] = '</span></div>\n  </div>\n  <div class="news-item"><a href="/en/ann-test-nginx-029.html">\n      <picture>\n        <source srcset="../images/test.webp" type="image/webp"/><img class="news-img" src="../images/test.png"/>\n      </picture></a>\n    <div class="news-description"><strong class="news-hint">'
-- line 16 "news-en.tt2"
